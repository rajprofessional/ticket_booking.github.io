...
@Entity
@Table(name = "Bus_Booking_Ticket")
public class Bus_Booking_Ticket {
	...
	@JsonIgnore
	private User user;
	public Bus_Booking_Ticket(long tId, long busNumber, String busName, String date, String to, String from,
			String depatureTime, String duration, String arivalTime, double price, String trivalClass, String tripType,
			String re_date, String intermediate, Object[] seatStore, String status, User user) {
		this.tId = tId;
	...
	public String toString() {
		return "Bus_Booking_Ticket [tId=" + tId + ", busNumber=" + busNumber + ", busName=" + busName + ", date=" + date
